      ...
      >
        <div className="space-y-5">
          <div>
            ...
            <p className="mt-3 text-base text-blue-100/90 sm:text-lg">{subtitle}</p>
          </div>
          <div className="mt-8 space-y-5 text-sm text-blue-100/90">
            <div className="rounded-xl bg-white/10 p-4 backdrop-blur-sm">
              <p className="font-semibold text-white text-base mb-2">Access CricTech Insights</p>
              <p className="leading-relaxed">
                Manage your AI-powered biomechanics dashboard, review session reports, and unlock premium coaching
                features.
              </p>
            </div>
            <div className="flex items-center gap-3 rounded-full bg-white/20 px-5 py-3 backdrop-blur-sm border border-white/20">
              <span className="text-xs uppercase tracking-wider text-blue-100 font-semibold">Trusted by</span>
              <span className="text-sm font-bold text-white">Coaches & Academies</span>
            </div>
          </div>
        </div>
      </motion.div>
      ...
      >
        ...
        <div className="space-y-3">
          <div className="flex items-center justify-between text-xs font-bold text-slate-700">
            ...
            <button type="button" className="text-blue-600 font-semibold transition hover:text-blue-500 hover:underline">
              Forgot password?
            </button>
          </div>
          <div className="relative">
